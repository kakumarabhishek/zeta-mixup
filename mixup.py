...
def mixup_data(x, y, alpha=1.0, use_cuda=True):
    ...
    Args:
        ...
        alpha (float, optional): The hyperparameter for mixup. 
                                 Defaults to 1.0.
        use_cuda (bool, optional): Specify if the GPU should be used. 
                                   Defaults to True.
    ...
    # Generate a shuffled index of the training batch and move to the GPU if 
    # specified.
    if use_cuda:
